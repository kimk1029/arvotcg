...
const REVIEW_POOL: ReviewItem[] = [
  { sid: 's1', avatar: '🐹', avGrad: 'linear-gradient(150deg,#ffe08a,#ffb347)', name: '포케사랑', time: '2시간 전', rating: '5.0', text: '오리파 구성이 진짜 알차요. 리자몽 SAR 뽑고 갑니다 ㅋㅋ 사장님도 친절하세요', tags: ['오리파 알참', '응대 친절'] },
  { sid: 's2', avatar: '🔮', avGrad: 'linear-gradient(150deg,#8e6bd6,#5a3aa8)', name: '뮤츠좋아', time: '5시간 전', rating: '4.5', text: '싱글 카드 종류가 많아서 좋았어요. 시세보다 살짝 저렴한 것도 꽤 있음', tags: ['재고 많음', '가격 착함'] },
  ...
  { sid: 's1', avatar: '⚡', avGrad: 'linear-gradient(150deg,#f9d423,#ff8a3c)', name: '피카매니아', time: '어제', rating: '4.5', text: '5만원 오리파에서 피카츄 AR 나왔어요! 구성 공개가 투명해서 믿고 사는 편', tags: ['오리파 알참', '매장 쾌적'] },
