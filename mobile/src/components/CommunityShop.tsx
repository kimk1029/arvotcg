...
const REVIEW_POOL: ReviewItem[] = [
  ...
  { sid: 's2', avatar: '🔮', avBg: '#7453bf', name: '홀로수집가', time: '5시간 전', rating: '4.5', text: '싱글 카드 종류가 많아서 좋았어요. 시세보다 살짝 저렴한 것도 꽤 있음', tags: ['재고 많음', '가격 착함'] },
...
export function ShopSection({ P, ts, region = '전체' }: { P: ShopPalette; ts: TsFn; region?: string }) {
  ...
  return (
    ...
    >
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 8, paddingBottom: 6, display: regionShops.length === 0 ? 'none' : 'flex' }}>
