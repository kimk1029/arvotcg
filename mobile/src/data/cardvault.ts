...
export const CARDS: CardItem[] = [
  { id: 1, name: 'Ember Drake', set: '크림슨 던', num: '006/165', game: '포켓몬', rar: 'SR', grade: 9, price: 128000, trend: [80, 90, 100, 110, 115, 120, 128], emoji: '🔥', owned: true },
  { id: 2, name: 'Aurora Fox', set: '비비드 볼트', num: '044/185', game: '포켓몬', rar: 'HR', grade: null, price: 85000, trend: [60, 65, 70, 75, 80, 82, 85], emoji: '⚡', owned: true },
  { id: 3, name: '블랙 로터스 재판', set: '언리미티드', num: '-', game: 'MTG', rar: 'S', grade: 8, price: 450000, trend: [400, 410, 420, 435, 440, 448, 450], emoji: '🌹', owned: true },
  { id: 4, name: 'Storm Falcon', set: '오리엔트', num: 'SP24', game: '원피스', rar: 'SR', grade: null, price: 32000, trend: [25, 26, 28, 30, 31, 31, 32], emoji: '🌊', owned: true },
  ...
  { id: 6, name: 'Solar Titan', set: '스카이 로드 2', num: 'SF04-001', game: '원피스', rar: 'HR', grade: null, price: 18000, trend: [12, 13, 15, 16, 17, 17, 18], emoji: '🥊', owned: false },
...
export const MARKET: MarketItem[] = [
  ...
  { id: 105, cardId: 4, type: 'trade', price: null, condition: 'NM', seller: '카드매니아', time: '5시간 전' },
  { id: 106, cardId: 7, type: 'sell', price: 39000, condition: 'LP', seller: '결투사', time: '1일 전' },
];

export const POSTS: PostItem[] = [
  { id: 201, user: 'CardMaster_KR', avatar: '🐉', time: '방금 전', text: '드디어 그레이딩 9 받았다!! 3개월 기다린 보람이 있네', hasCard: true, card: CARDS[0], likes: 24, comments: 8, type: 'showcase' },
  { id: 202, user: '카드매니아2', avatar: '⚡', time: '15분 전', text: '이 카드 상태 어떻게 보시나요? 제출 전에 감정 부탁드립니다', hasCard: true, card: CARDS[1], likes: 12, comments: 15, type: 'grade-req' },
