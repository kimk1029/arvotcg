...
import flexRouter from './routes/flex.ts';
...
import infoPostsRouter from './routes/infoPosts.ts';
...
app.use('/api/cardshow', cardshowRouter);
app.use('/api/banners', bannersRouter);
app.use('/api/info-posts', infoPostsRouter);
